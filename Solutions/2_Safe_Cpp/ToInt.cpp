...
//  - Very simple
// Cons:
//  - It is impossible to distinguish between "good" 0s and errors
...
// Pros:
//  - Simple
//  - No confusion between success and failure
//  - Errors cannot be ignored
// Cons:
//  - Potentially very expensive in the error case
...
// Cons:
//  - Inconvenient to use
//  - No const possible (the Initialize-Then-Modify (ITM) antipattern)
...
//  - Errors cannot be ignored
// Cons:
//  - Very expensive due to memory allocation
//  - Requires resource management
//  - Usage slightly inconvenient due to pointer access
/*
...
//  - efficient and fast (no memory allocation)
// Cons:
//  - Usage slightly inconvenient due to pointer-like access
