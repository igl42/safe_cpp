/**************************************************************************************************
*
* \file RangesRefactoring_Countries.cpp
...
*
* Step 2: Considering the general case, the initial code contains a bug. For which input
*         does the given solution not work?
*
* Step 3: Improve readability by choosing better names for the variables.
*
* Step 4: Refactor the 'main()' function from an imperative to a declarative style by means
*         of C++20 ranges.
*
**************************************************************************************************/
...
constexpr auto is_more_populated()
{
   return []( Country const& lhs, Country const& rhs )
   {
